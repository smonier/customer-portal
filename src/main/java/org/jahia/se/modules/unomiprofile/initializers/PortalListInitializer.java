...
public class PortalListInitializer extends AbstractChoiceListRenderer implements ModuleChoiceListInitializer, ModuleChoiceListRenderer {
    private static final Logger logger = LoggerFactory.getLogger(PortalListInitializer.class);
    ...
    public List<ChoiceListValue> getChoiceListValues(ExtendedPropertyDefinition epd, String param, List<ChoiceListValue> values,
        ...
        myPropertiesMap.put("addMixin","portalmix:folderList");
        myChoiceList.add(new ChoiceListValue("folderList",myPropertiesMap,new ValueImpl("folderList", PropertyType.STRING, false)));

        //multiple Images
        myPropertiesMap = new HashMap<String, Object>();
        myPropertiesMap.put("addMixin","portalmix:contentList");
        myChoiceList.add(new ChoiceListValue("contentList",myPropertiesMap,new ValueImpl("contentList", PropertyType.STRING, false)));
